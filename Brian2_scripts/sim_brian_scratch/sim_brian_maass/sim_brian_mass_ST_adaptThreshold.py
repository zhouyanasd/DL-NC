...
G_ex = NeuronGroup(n_ex, neuron, threshold=adaptive_threshold, reset=adaptive_reset, method='euler', refractory=3 * ms,
                name ='neurongroup_ex')

G_inh = NeuronGroup(n_inh, neuron, threshold=adaptive_threshold, reset=adaptive_reset, method='euler', refractory=2 * ms,
                name ='neurongroup_in')
