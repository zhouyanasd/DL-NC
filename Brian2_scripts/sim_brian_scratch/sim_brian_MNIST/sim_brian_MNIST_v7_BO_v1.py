...
def run_net(inputs, **parameter):
    ...
    tau_ex = [parameter['tau_0'],parameter['tau_1'],parameter['tau_2'],parameter['tau_3']]*coding_duration
    tau_inh = [parameter['tau_0'],parameter['tau_1'],parameter['tau_2'],parameter['tau_3']]*coding_duration
    tau_read= 30
