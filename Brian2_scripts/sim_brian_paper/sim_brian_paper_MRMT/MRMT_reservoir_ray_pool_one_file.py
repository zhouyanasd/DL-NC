...
try:
    ...
    HAPT.load_data_HAPT_all(data_path_HAPT)
    ...
    df_en_train_HAPT = HAPT.encoding_latency_HAPT(HAPT._encoding_cos_rank_ignore_0, df_train_HAPT, coding_n_HAPT)
    df_en_pre_train_HAPT = HAPT.encoding_latency_HAPT(HAPT._encoding_cos_rank_ignore_0, df_pre_train_HAPT, coding_n_HAPT)
    df_en_validation_HAPT = HAPT.encoding_latency_HAPT(HAPT._encoding_cos_rank_ignore_0, df_validation_HAPT, coding_n_HAPT)
    df_en_test_HAPT = HAPT.encoding_latency_HAPT(HAPT._encoding_cos_rank_ignore_0, df_test_HAPT, coding_n_HAPT)
